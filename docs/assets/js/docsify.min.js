!function () {
    ...
    }), l = Object.prototype.hasOwnProperty, d = Object.assign || function (e) {
    ...
    var f = document, v = f.body, b = f.head;
    ...
    function E(e, t) {
        ...
        return e.forEach(function (e) {
            n += '<li><a class="section-link" href="' + e.slug + '" title="' + e.title + '">' + e.title + "</a></li>", e.children && (n += E(e.children, t))
        }), t.replace("{inner}", n)
    }
    ...
    function L(e) {
        ...
        $ || function () {
            var e = w("div");
            e.classList.add("progress"), s(v, e), $ = e
        }(), t = i ? 80 < (t = parseInt($.style.width || 0, 10) + i) ? 80 : t : Math.floor(n / r * 100), $.style.opacity = 1, $.style.width = 95 <= t ? "100%" : t + "%", 95 <= t && (clearTimeout(C), C = setTimeout(function (e) {
            $.style.opacity = 0, $.style.width = "0%"
        }, 200))
    }
    ...
    function R(a, e, t) {
        ...
        var s = new XMLHttpRequest, r = T[a];
        if (r) return {
            then: function (e) {
            ...
            then: function (r, i) {
                if (void 0 === i && (i = h), e) {
                    var t = setInterval(function (e) {
                        return L({step: Math.floor(5 * Math.random() + 1)})
                    }, 500);
                    n("progress", L), n("loadend", function (e) {
                        L(e), clearInterval(t)
                    })
                }
                n("error", i), n("load", function (e) {
                    ...
                    if (400 <= t.status) i(t); else {
                        var n = T[a] = {content: t.response, opt: {updatedAt: s.getResponseHeader("last-modified")}};
                        r(n.content, n.opt)
                    }
                })
            }, abort: function (e) {
    ...
    var j = N(function (v, e) {
        !function () {
            ...
            y._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, y._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, y.def = e(y.def).replace("label", y._label).replace("title", y._title).getRegex(), y.bullet = /(?:[*+-]|\d{1,9}\.)/, y.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/, y.item = e(y.item, "gm").replace(/bull/g, y.bullet).getRegex(), y.list = e(y.list).replace(/bull/g, y.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + y.def.source + ")").getRegex(), y._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", y._comment = /<!--(?!-?>)[\s\S]*?-->/, y.html = e(y.html, "i").replace("comment", y._comment).replace("tag", y._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), y.paragraph = e(y._paragraph).replace("hr", y.hr).replace("heading", " {0,3}#{1,6} +").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}|~{3,})[^`\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", y._tag).getRegex(), y.blockquote = e(y.blockquote).replace("paragraph", y.paragraph).getRegex(), y.normal = d({}, y), y.gfm = d({}, y.normal, {
                ...
                for (e = e.replace(/^ +$/gm, ""); e;) if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), 1 < i[0].length && this.tokens.push({type: "space"})), i = this.rules.code.exec(e)) {
                    ...
                    for (e = e.substring(i[0].length), l = {
                        ...
                        start: f ? +a : "",
                        loose: !1
                    }, this.tokens.push(l), n = !(c = []), g = (i = i[0].match(this.rules.item)).length, p = 0; p < g; p++) h = (o = i[p]).length, ~(o = o.replace(/^ *([*+-]|\d+\.) */, "")).indexOf("\n ") && (h -= o.length, o = this.options.pedantic ? o.replace(/^ {1,4}/gm, "") : o.replace(new RegExp("^ {1," + h + "}", "gm"), "")), p !== g - 1 && (s = y.bullet.exec(i[p + 1])[0], (1 < a.length ? 1 === s.length : 1 < s.length || this.options.smartLists && s !== a) && (e = i.slice(p + 1).join("\n") + e, p = g - 1)), r = n || /\n\n(?!\s*$)/.test(o), p !== g - 1 && (n = "\n" === o.charAt(o.length - 1), r = r || n), r && (l.loose = !0), v = void 0, (m = /^\[[ xX]\] /.test(o)) && (v = " " !== o[1], o = o.replace(/^\[[ xX]\] +/, "")), u = {
                        type: "list_item_start",
                        task: m,
                        checked: v,
                        loose: r
                    }, c.push(u), this.tokens.push(u), this.token(o, !1), this.tokens.push({type: "list_item_end"});
            ...
            function a(e, t, n) {
                ...
                t && !o.test(n) && (n = function (e, t) {
                    ...
                    return e = s[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t : "/" === t.charAt(0) ? e.replace(/(:\/*[^/]*)[\s\S]*/, "$1") + t : e + t
                }(t, n));
                try {
            ...
            n._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~", n.em = e(n.em).replace(/punctuation/g, n._punctuation).getRegex(), n._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, n._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, n._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, n.autolink = e(n.autolink).replace("scheme", n._scheme).replace("email", n._email).getRegex(), n._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, n.tag = e(n.tag).replace("comment", y._comment).replace("attribute", n._attribute).getRegex(), n._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, n._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/, n._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, n.link = e(n.link).replace("label", n._label).replace("href", n._href).replace("title", n._title).getRegex(), n.reflink = e(n.reflink).replace("label", n._label).getRegex(), n.normal = d({}, n), n.pedantic = d({}, n.normal, {
            ...
            }), n.gfm.url = e(n.gfm.url, "i").replace("email", n.gfm._extended_email).getRegex(), n.breaks = d({}, n.gfm, {
                ...
                for (var t, n, r, i, a, s, o = ""; e;) if (a = this.rules.escape.exec(e)) e = e.substring(a[0].length), o += k(a[1]); else if (a = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(a[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(a[0]) && (this.inLink = !1), !this.inRawBlock && /^<(pre|code|kbd|script)(\s|>)/i.test(a[0]) ? this.inRawBlock = !0 : this.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(a[0]) && (this.inRawBlock = !1), e = e.substring(a[0].length), o += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : k(a[0]) : a[0]; else if (a = this.rules.link.exec(e)) {
                    var l = g(a[2], "()");
                    if (-1 < l) {
                        var c = 4 + a[1].length + l;
                        a[2] = a[2].substring(0, l), a[0] = a[0].substring(0, c).trim(), a[3] = ""
                    }
                    e = e.substring(a[0].length), this.inLink = !0, r = a[2], i = this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(r)) ? (r = t[1], t[3]) : "" : a[3] ? a[3].slice(1, -1) : "", r = r.trim().replace(/^<([\s\S]*)>$/, "$1"), o += this.outputLink(a, {
                        href: u.escapes(r),
                        title: u.escapes(i)
                    }), this.inLink = !1
                    ...
                    if (a = this.rules.text.exec(e)) e = e.substring(a[0].length), this.inRawBlock ? o += this.renderer.text(this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : k(a[0]) : a[0]) : o += this.renderer.text(k(this.smartypants(a[0]))); else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                } else {
                    if ("@" === a[2]) r = "mailto:" + (n = k(a[0])); else {
                        for (; s = a[0], a[0] = this.rules._backpedal.exec(a[0])[0], s !== a[0];) ;
                        n = k(a[0]), r = "www." === a[1] ? "http://" + n : n
                    }
                    e = e.substring(a[0].length), o += this.renderer.link(r, null, n)
                }
                return o
                ...
                this.inline = new u(e.links, this.options), this.inlineText = new u(e.links, d({}, this.options, {renderer: new i})), this.tokens = e.reverse();
                ...
                switch (this.token.type) {
                    ...
                    case"list_start":
                        a = "";
                        for (var s = this.token.ordered, o = this.token.start; "list_end" !== this.next().type;) a += this.tok();
            ...
            function m(e, n, r) {
                ...
                if (r || "function" == typeof n) {
                    r || (r = n, n = null), f(n = d({}, m.defaults, n || {}));
                    var i, a, s = n.highlight, t = 0;
                    try {
                        i = l.lex(e, n)
                    } catch (e) {
                        return r(e)
                    ...
                    for (; t < i.length; t++) !function (n) {
                        "code" !== n.type ? --a || o() : s(n.text, n.lang, function (e, t) {
                            return e ? o(e) : null == t || t === n.text ? --a || o() : (n.text = t, n.escaped = !0, void (--a || o()))
                        })
                    }(i[t])
                } else try {
                    return f(n = n && d({}, m.defaults, n)), c.parse(l.lex(e, n), n)
                } catch (e) {
        ...
        var c = function (c) {
            var u = /\blang(?:uage)?-([\w-]+)\b/i, t = 0, T = {
                    ...
                    encode: function (e) {
                        ...
                        switch (r = r || {}, a) {
                            case"Object":
                                ...
                                for (var s in i = {}, r[t] = i, e) e.hasOwnProperty(s) && (i[s] = n(e[s], r));
                                return i;
                            case"Array":
                                return t = T.util.objId(e), r[t] ? r[t] : (i = [], r[t] = i, e.forEach(function (e, t) {
                                    i[t] = n(e, r)
                                }), i);
                            default:
                                return e
                ...
                highlightElement: function (e, t, n) {
                    for (var r, i = "none", a = e; a && !u.test(a.className);) a = a.parentNode;
                    a && (i = (a.className.match(u) || [, "none"])[1].toLowerCase(), r = T.languages[i]), e.className = e.className.replace(u, "").replace(/\s+/g, " ") + " language-" + i, e.parentNode && (a = e.parentNode, /pre/i.test(a.nodeName) && (a.className = a.className.replace(u, "").replace(/\s+/g, " ") + " language-" + i));

                    function s(e) {
                        o.highlightedCode = e, T.hooks.run("before-insert", o), o.element.innerHTML = o.highlightedCode, T.hooks.run("after-highlight", o), T.hooks.run("complete", o), n && n.call(o.element)
                    }

                    var o = {element: e, language: i, grammar: r, code: e.textContent};
                    ...
                    } else s(T.highlight(o.code, o.grammar, o.language)); else s(T.util.encode(o.code)); else T.hooks.run("complete", o)
                },
                highlight: function (e, t, n) {
                    var r = {code: e, grammar: t, language: n};
                    return T.hooks.run("before-tokenize", r), r.tokens = T.tokenize(r.code, r.grammar), T.hooks.run("after-tokenize", r), R.stringify(T.util.encode(r.tokens), r.language)
                },
                            ...
                            for (var v = r, b = i; v < t.length; b += t[v].length, ++v) {
                                ...
                                if (!(y instanceof R)) {
                                    ...
                                    if (A) {
                                        ...
                                        var C = y.slice(0, k), E = y.slice(w), F = [v, $];
        ...
        e.exports && (e.exports = c), void 0 !== t && (t.Prism = c), c.languages.markup = {
            comment: /<!--[\s\S]*?-->/,
            prolog: /<\?[\s\S]+?\?>/,
            ...
            }), c.plugins.toolbar && c.plugins.toolbar.registerButton("download-file", function (e) {
    ...
    var U = decodeURIComponent, Y = encodeURIComponent;
        ...
        buildPlaceholders: {
            ...
            value: function (d, g) {
                if (d.language === g && d.tokenStack) {
                    ...
                    var f = 0, m = Object.keys(d.tokenStack);
                    !function e(t) {
                        for (var n = 0; n < t.length && !(f >= m.length); n++) {
                            var r = t[n];
                            if ("string" == typeof r || r.content && "string" == typeof r.content) {
                                var i = m[f], a = d.tokenStack[i], s = "string" == typeof r ? r : r.content,
                                    o = ne(g, i), l = s.indexOf(o);
                                if (-1 < l) {
                                    ++f;
                                    var c = s.substring(0, l),
                                        u = new ee.Token(g, ee.tokenize(a, d.grammar), "language-" + g, a),
                                        h = s.substring(l + o.length), p = [];
                                    c && p.push.apply(p, e([c])), p.push(u), h && p.push.apply(p, e([h])), "string" == typeof r ? t.splice.apply(t, [n, 1].concat(p)) : r.content = p
                                }
    ...
    var ae = {
        ...
        var s, t = this._initRenderer(), n = i.markdown || {};
        s = r(n) ? n(j, t) : (j.setOptions(d(n, {renderer: d(t, n.renderer)})), j), this._marked = s, this.compile = function (n) {
            var r = !0, e = o(function (e) {
                r = !1;
                var t = "";
    ...
    se.prototype.compileEmbed = function (e, t) {
        var n, r = ie(t), i = r.str, a = r.config;
        if (t = i, a.include) {
            var s;
            if (W(e) || (e = K(this.contentBase, X(this.router.getCurrentPath()), e)), a.type && (s = ae[a.type])) (n = s.call(this, e, t)).type = a.type; else {
                var o = "code";
                /\.(md|markdown)/.test(e) ? o = "markdown" : /\.mmd/.test(e) ? o = "mermaid" : /\.html?/.test(e) ? o = "iframe" : /\.(mp4|ogg)/.test(e) ? o = "video" : /\.mp3/.test(e) && (o = "audio"), (n = ae[o].call(this, e, t)).type = o
            }
        ...
        var e = new j.Renderer, o = this.linkTarget, l = this.linkRel, u = this.router, h = this.contentBase, c = this,
            t = {};
        return t.heading = e.heading = function (e, t) {
            var n = ie(e), r = n.str, i = n.config, a = {level: t, title: r};
            ...
            var s = B(i.id || r), o = u.toURL(u.getCurrentPath(), {id: s});
            return a.slug = o, c.toc.push(a), "<h" + t + ' id="' + s + '"><a href="' + o + '" data-id="' + s + '" class="anchor"><span>' + r + "</span></a></h" + t + ">"
        }, t.code = e.code = function (e, t) {
            return void 0 === t && (t = ""), e = e.replace(/@DOCSIFY_QM@/g, "`"), '<pre v-pre data-lang="' + t + '"><code class="lang-' + t + '">' + M.highlight(e, M.languages[t] || M.languages.markup) + "</code></pre>"
        }, t.link = e.link = function (e, t, n) {
            void 0 === t && (t = "");
            var r = "", i = ie(t), a = i.str, s = i.config;
            return t = a, W(e) || c._matchNotCompileLink(e) || s.ignore ? (r += 0 === e.indexOf("mailto:") ? "" : ' target="' + o + '"', r += 0 === e.indexOf("mailto:") ? "" : "" !== l ? ' rel="' + l + '"' : "") : (e === c.config.homepage && (e = "README"), e = u.toURL(e, null, u.getCurrentPath())), s.target && (r += " target=" + s.target), s.disabled && (r += " disabled", e = "javascript:void(0)"), t && (r += ' title="' + t + '"'), '<a href="' + e + '"' + r + ">" + n + "</a>"
        }, t.paragraph = e.paragraph = function (e) {
            return /^!&gt;/.test(e) ? F("tip", e) : /^\?&gt;/.test(e) ? F("warn", e) : "<p>" + e + "</p>"
        }, t.image = e.image = function (e, t, n) {
            var r = e, i = "", a = ie(t), s = a.str, o = a.config;
            t = s, o["no-zoom"] && (i += " data-no-zoom"), t && (i += ' title="' + t + '"');
            var l = o.size;
            if (l) {
                var c = l.split("x");
                c[1] ? i += "width=" + c[0] + " height=" + c[1] : i += "width=" + c[0]
            }
            return W(e) || (r = K(h, X(u.getCurrentPath()), e)), '<img src="' + r + '"data-origin="' + e + '" alt="' + n + '"' + i + ">"
        ...
        if (e) i = this.compile(e); else {
            ...
            i = E(l, "<ul>{inner}</ul>"), this.cacheTree[r] = l
        }
        return i
    ...
    function ce(e, t, r, n) {
        ...
        }), n && (f.title = a ? a.title || a.innerText + " - " + oe : oe), a
    }
    ...
    function pe() {
        ...
        }(this, pe), this.start = e.start, this.end = e.end, this.decimal = e.decimal
    }
    ...
    function fe() {
        ...
        !function (e, t) {
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
        }(this, fe), this.duration = e.duration || 1e3, this.ease = e.easing || this._defaultEase, this.tweener = e.tweener || new he(e), this.start = this.tweener.start, this.end = this.tweener.end, this.frame = null, this.next = null, this.isRunning = !1, this.events = {}, this.direction = this.start < this.end ? "up" : "down"
    }

    var me = {}, ve = !1, be = null, ye = !0, ke = 0;
        ...
        if (ye) {
            ...
            if (t) {
                ...
                if (h && h !== a && (a && a.classList.remove("active"), h.classList.add("active"), a = h, !ve && v.classList.contains("sticky"))) {
                    var p = n.clientHeight, d = a.offsetTop + a.clientHeight + 40, g = d - 0 < p,
    ...
    function _e(e, t) {
        if (t) {
            ...
            var r = me[xe(e, t)], i = y(m(".sidebar"), "li.active");
            i && i.classList.remove("active"), r && r.classList.add("active")
        }
    }
    ...
    function $e(e, i) {
        var s = e.compiler, a = e.raw;
        void 0 === a && (a = "");
        var t = e.fetch, n = Ae[a];
        if (n) {
            var r = n.slice();
            return r.links = n.links, i(r)
        }
        var o = s._marked, l = o.lexer(a), c = [], u = o.InlineLexer.rules.link, h = l.links;
        ...
        var p = 0;
        !function (e, a) {
            var t, n = e.embedTokens, s = e.compile, o = (e.fetch, 0), l = 1;
            if (!n.length) return a({});
            for (; t = n[o++];) {
                var r = function (i) {
                    return function (e) {
                        var t;
                        if (e) if ("markdown" === i.embed.type) t = s.lexer(e); else if ("code" === i.embed.type) {
                            if (i.embed.fragment) {
                        ...
                        a({token: i, embedToken: t}), ++l >= o && a({})
                    }
                }(t);
                t.embed.url ? R(t.embed.url).then(r) : r(t.embed.html)
            }
        }({compile: o, embedTokens: c, fetch: t}, function (e) {
            var t = e.embedToken, n = e.token;
            if (n) {
                var r = n.index + p;
                d(h, t.links), l = l.slice(0, r).concat(t, l.slice(r + 1)), p += t.length - 1
            } else Ae[a] = l.concat(), l.links = Ae[a].links = h, i(l)
        })
    }
    ...
    function Ee(e, t, n) {
        return t = "function" == typeof n ? n(t) : "string" == typeof n ? function (r, i) {
            var a = [], s = 0;
            return r.replace(P, function (t, e, n) {
                a.push(r.substring(s, n - 1)), s = n += t.length + 1, a.push(i && i[t] || function (e) {
                    return ("00" + ("string" == typeof z[t] ? e[z[t]]() : z[t](e))).slice(-t.length)
                })
            }), s !== r.length && a.push(r.substring(s)), function (e) {
    ...
    function Fe(e) {
        e = e || "<h1>404 - Not found</h1>", this._renderTo(".markdown-section", e), this.config.loadSidebar || this._renderSidebar(), !1 === this.config.executeScript || void 0 === window.Vue || Ce() ? this.config.executeScript && Ce() : setTimeout(function (e) {
    ...
    function Le(e) {
        var t = e.config;
        e.compiler = new se(t, e.router), window.__current_docsify_compiler__ = e.compiler;
        var n = t.el || "#app", r = y("nav") || w("nav"), i = y(n), a = "", s = v;
        if (i) {
            if (t.repo && (a += function (e, t) {
                ...
                var o = /^data:image/.test(t.logo), l = /(?:http[s]?:)?\/\//.test(t.logo), c = /^\./.test(t.logo);
        ...
        t.mergeNavbar && g ? s = y(".sidebar") : (r.classList.add("app-nav"), t.repo || r.classList.add("no-badge")), t.loadNavbar && x(s, r), t.themeColor && (f.head.appendChild(w("div", function (e) {
            return "<style>:root{--theme-color: " + e + ";background: #f5f5d5;}</style>"
        }(t.themeColor)).firstElementChild), function (n) {
            if (!(window.CSS && window.CSS.supports && window.CSS.supports("(--v:red)"))) {
                var e = k("style:not(.inserted),link");
                [].forEach.call(e, function (e) {
                    if ("STYLE" === e.nodeName) O(e, n); else if ("LINK" === e.nodeName) {
                        var t = e.getAttribute("href");
                        if (!/\.css$/.test(t)) return;
                        R(t).then(function (e) {
                            var t = w("style", e);
                            b.appendChild(t), O(t, n)
                        })
                    }
                })
            }
        }(t.themeColor)), e._updateRender(), A(v, "ready")
    }
    ...
    Re.prototype.getBasePath = function () {
        ...
        }(e, n.alias) : e, i)) === "/README" + i && n.homepage || e, e = W(e) ? e : K(r, e), t && (e = e.replace(new RegExp("^" + r), "")), e
        ...
        var r = n && "#" === e[0], i = this.parse(te(e));
        if (i.query = d({}, i.query, t), e = (e = i.path + V(i.query)).replace(/\.md(\?)|\.md$/, "$1"), r) {
            var a = n.indexOf("?");
    ...
    var Pe = function (r) {
        ...
        return r && (e.__proto__ = r), ((e.prototype = Object.create(r && r.prototype)).constructor = e).prototype.getBasePath = function () {
            ...
            0 <= n && (e = e.slice(n + 1));
            var r = e.indexOf("?");
            return 0 <= r && (t = e.slice(r + 1), e = e.slice(0, r)), {path: e, file: this.getFile(e, !0), query: G(t)}
        ...
        return t && (e.__proto__ = t), ((e.prototype = Object.create(t && t.prototype)).constructor = e).prototype.getCurrentPath = function () {
            ...
            void 0 === r && (r = h), _("click", function (e) {
            ...
            var r = K(location.origin), i = e.indexOf(r);
            return -1 < i && (e = e.slice(i + r.length)), {path: e, file: this.getFile(e), query: G(t)}
        }, e
    }(Re);
    var Ne = {};
    ...
    function Me(e) {
        !function (e) {
            ...
            null != (e = m(e)) && (_(e, "click", function (e) {
                e.stopPropagation(), t()
            }), g && _(v, "click", function (e) {
        ...
        }(".sidebar", e.router), e.config.coverpage ? g || _("scroll", le) : v.classList.add("sticky")
    }

    function qe(t, n, r, i, a, e) {
        t = e ? t : t.replace(/\/$/, ""), (t = X(t)) && R(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(i, function (e) {
            return qe(t, n, r, i, a)
        })
    }
    ...
    function Ye(e, t, n) {
        return De && De.abort && De.abort(), De = R(e, !0, n)
    }
    ...
    Ue._init = function () {
        ...
        }(e), p(e, "init"), function (t) {
            var e, n = t.config;
            e = "history" === (n.routerMode || "hash") && a ? new ze(n) : new Pe(n), t.router = e, je(t), Ne = t.route, e.onchange(function (e) {
                je(t), t._updateRender(), Ne.path !== t.route.path ? (t.$fetch(), Ne = t.route) : t.$resetEvents()
            })
        }(e), Le(e), Me(e), function (t) {
            var e = t.config.loadSidebar;
            if (t.rendered) {
                var n = ce(t.router, ".sidebar-nav", !0, !0);
                e && n && (n.parentNode.innerHTML += window.__SUB_SIDEBAR__), t._bindEventOnRendered(n), t.$resetEvents(), p(t, "doneEach"), p(t, "ready")
            } else t.$fetch(function (e) {
                return p(t, "ready")
            })
        }(e), p(e, "mounted")
    }, Ue.route = {}, (Ze = Ue)._renderTo = function (e, t, n) {
        var r = m(e);
        ...
        if (function (e) {
            ...
            var i = m("#main"), a = i.children[0];
            if (a && "H1" !== a.tagName) {
                var s = w("h1");
                s.innerText = e.innerText, x(i, s)
            }
        }
        r && function (e) {
            void 0 === e && (e = 0), Se.scrollTop = !0 === e ? 0 : Number(e)
        }(r)
    }, Ze._renderNav = function (e) {
        e && this._renderTo("nav", this.compiler.compile(e)), this.config.loadNavbar && ce(this.router, "nav")
    }, Ze._renderMain = function (r, i, a) {
        var s = this;
        if (void 0 === i && (i = {}), !r) return Fe.call(this, r);
        p(this, "beforeEach", r, function (e) {
            function t() {
                i.updatedAt && (n = Ee(n, i.updatedAt, s.config.formatUpdated)), p(s, "afterEach", n, function (e) {
                    return Fe.call(s, e)
                })
            }

            var n;
            s.isHTML ? (n = s.result = r, t(), a()) : $e({compiler: s.compiler, raw: e}, function (e) {
                n = s.compiler.compile(e), t(), a()
            })
        })
        ...
        if (A(m("main"), t ? "add" : "remove", "hidden"), e) {
            ...
            if (i) {
                if ("color" === i[2]) n.style.background = i[1] + (i[3] || ""); else {
                    var a = i[1];
                    A(n, "add", "has-mask"), W(i[1]) || (a = K(this.router.getBasePath(), i[1])), n.style.backgroundImage = "url(" + a + ")", n.style.backgroundSize = "cover", n.style.backgroundPosition = "center center"
                }
                r = r.replace(i[0], "")
            }
        ...
        var r = this;
        void 0 === n && (n = h);
        var e = this.route, i = e.path, a = V(e.query, ["id"]), t = this.config, s = t.loadNavbar, o = t.requestHeaders,
            l = t.loadSidebar, c = this.router.getFile(i), u = Ye(c + a, 0, o);
        ...
        var t = this, e = this.config, n = e.coverpage, r = e.requestHeaders, i = this.route.query,
            a = X(this.route.path);
        if (n) {
            var s = null, o = this.route.path;
            if ("string" == typeof n) "/" === o && (s = n); else if (Array.isArray(n)) s = -1 < n.indexOf(o) && "_coverpage"; else {
                var l = n[o];
                s = !0 === l ? "_coverpage" : l
            }
        ...
        void 0 === e && (e = h), this._fetchCover() ? n() : this._fetch(function () {
            t.$resetEvents(), n()
        })
    }, Be._fetchFallbackPage = function (n, r, i) {
        var a = this;
        void 0 === i && (i = h);
        var e = this.config, t = e.requestHeaders, s = e.fallbackLanguages, o = e.loadSidebar;
        if (!s) return !1;
        var l = n.split("/")[1];
        ...
        var r = this;
        void 0 === n && (n = h);
        var i = this.config, a = i.loadSidebar, s = i.requestHeaders, o = i.notFoundPage,
        ...
        _e(this.route.path, this.route.query.id), this.config.loadNavbar && ce(this.router, "nav")
    }, window.Docsify = {
        util: He,
        dom: e,
        get: R,
        slugify: B,
        version: "4.10.2"
    }, window.DocsifyCompiler = se, window.marked = j, window.Prism = M, function (e) {
