!function (t, e) {
    ...
    var o = function (t, e) {
            ...
            return t
        }, f = {previousText: "PREVIOUS", nextText: "NEXT", crossChapter: !1, crossChapterText: !1},
        d = "docsify-pagination-container";
    ...
    var v = function () {
        function n(t) {
            var e;
            (o(this, n), t) && (this.chapter = (e = p(t, "div > ul > li"), c("p", e)), this.hyperlink = m(t))
        }
    ...
    window.$docsify = window.$docsify || {}, window.$docsify.plugins = [function (t, e) {
        var n = u({}, f, e.config.pagination || {});

        function i() {
            var t = c("." + d);
            t && (t.innerHTML = x.inner(function (t, e) {
                try {
                    var n = t.route.path, i = h(c.all(".sidebar li a")).filter(function (t) {
                        return !s(t, ".section-link")
                    }), a = i.find(g(n)), r = h((p(a, "ul") || {}).children).filter(function (t) {
                        return "LI" === t.tagName.toUpperCase()
                    }), o = e ? i.findIndex(g(n)) : r.findIndex(function (t) {
                        var e = m(t);
                        return e && g(n, e)
                    }), l = e ? i : r;
                    return {prev: new v(l[o - 1]).toJSON(), next: new v(l[o + 1]).toJSON()}
                } catch (t) {
                    return {}
                }
            }(e, n.crossChapter), n))
