...
![调试 XmlBeanDefinitionReaderTests 类](https://studyimages.oss-cn-beijing.aliyuncs.com/img/Spring/202211011443719.png)
...
![调试 ClassPathXmlApplicationContextTests 类](https://studyimages.oss-cn-beijing.aliyuncs.com/img/Spring/202211011446577.png)

再额外分享一个小技巧，如果在阅读 Spring 源码的时候，发现一个逻辑的分支走不到，我们在该处打上断点，然后执行整个目录的单元测试。如下图所示：

![Spring 调试小技巧](https://studyimages.oss-cn-beijing.aliyuncs.com/img/Spring/202211011447520.png)
